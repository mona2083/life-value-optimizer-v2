...
DEFAULT_ITEMS = [
    ...
    {"category": "leisure", "priority": 2,
     "name_ja": "外飲み・バー（週1〜2回）", "name_en": "Bars / Nights Out (1-2x week)",
     "initial_cost": 0, "monthly_cost": 120,
     "health": -3, "connections": 9, "freedom": 2, "growth": 1, "note_ja": "交友に効くがコスト高", "note_en": "Great for social ties, higher spend"},
    {"category": "leisure", "priority": 3,
     "name_ja": "宅飲み・ワイン/クラフトビール", "name_en": "Home Drinks / Wine / Craft Beer",
